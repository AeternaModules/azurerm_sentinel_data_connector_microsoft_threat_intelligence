output "sentinel_data_connector_microsoft_threat_intelligences_id" {
  ...
  value       = { for k, v in azurerm_sentinel_data_connector_microsoft_threat_intelligence.sentinel_data_connector_microsoft_threat_intelligences : k => v.id }
}
output "sentinel_data_connector_microsoft_threat_intelligences_log_analytics_workspace_id" {
  ...
  value       = { for k, v in azurerm_sentinel_data_connector_microsoft_threat_intelligence.sentinel_data_connector_microsoft_threat_intelligences : k => v.log_analytics_workspace_id }
}
output "sentinel_data_connector_microsoft_threat_intelligences_microsoft_emerging_threat_feed_lookback_date" {
  ...
  value       = { for k, v in azurerm_sentinel_data_connector_microsoft_threat_intelligence.sentinel_data_connector_microsoft_threat_intelligences : k => v.microsoft_emerging_threat_feed_lookback_date }
}
output "sentinel_data_connector_microsoft_threat_intelligences_name" {
  ...
  value       = { for k, v in azurerm_sentinel_data_connector_microsoft_threat_intelligence.sentinel_data_connector_microsoft_threat_intelligences : k => v.name }
}
output "sentinel_data_connector_microsoft_threat_intelligences_tenant_id" {
  ...
  value       = { for k, v in azurerm_sentinel_data_connector_microsoft_threat_intelligence.sentinel_data_connector_microsoft_threat_intelligences : k => v.tenant_id }
}
